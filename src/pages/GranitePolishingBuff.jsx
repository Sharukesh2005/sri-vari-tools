...
function GranitePolishingBuff() {
  const product = products.granitePolishingBuff;

  const [selectedGrit, setSelectedGrit] = useState("36");
      ...
      <div className="diamond-page">
        ...
        <div className="product-container">
          ...
          <div className="product-content">
            ...
            <ul>
              <li>✔ Superior Granite Surface Finish</li>
              <li>✔ High Wear Resistance</li>
              <li>✔ Uniform Polishing Performance</li>
              <li>✔ Long Service Life</li>
              <li>✔ Suitable for Automatic & Manual Machines</li>
            </ul>
...
export default GranitePolishingBuff;